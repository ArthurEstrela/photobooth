...
const TEMPLATES = [
  { id: 't-1', name: 'Floral', overlayUrl: 'https://s3/t1.png', photoCount: 1, layout: null, order: 0 },
  { id: 't-2', name: 'Gold',   overlayUrl: 'https://s3/t2.png', photoCount: 4, layout: 'grid', order: 1 },
];
